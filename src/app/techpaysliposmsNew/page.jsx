    ...
    <div>
      ...
      >
        <div class="main" style={{ zoom: "1.3" }}>
          <div class="top" style={{ fontSize: "smaller", margin: "10px auto" }}>
            <div>
              <img
                class="img2"
          ...
          >
            ...
            <tr>
              {desig === "AT" ? (
                <>
                  ...
                  <td style={{ textAlign: "right", borderRight: "1px solid" }}>
            ...
            <tr>
              <td colSpan="8" style={{ borderTop: "1px solid" }}>
                <table>
                  <tr>
                    <th style={{ textAlign: "left", width: 100 }}>NET PAY:</th>
        ...
        >
          <p>
            Disclaimer: This is a computer generated Pay Slip and hence does not
