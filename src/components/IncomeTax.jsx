    ...
    >
      <Page size="A4" orientation="portrait" style={styles.page}>
        <View style={styles.pageMainView}>
          <View style={styles.mainBorderView}>
            <View
              style={[styles.tableStartBorderView, { flexDirection: "column" }]}
            >
            ...
            >
              ...
              >
                <View style={{ borderRightWidth: 1 }}>
                  <Text style={[styles.text, { padding: 2, paddingRight: 30 }]}>
                    PAN:{" "}
                  </Text>
                </View>
                <View
            ...
            >
              <View style={{ borderRightWidth: 1, width: "80%" }}>
                <Text style={[styles.text, { textAlign: "left" }]}>
                  ...
                  last figure of Total Income is five of more, the amount shall
                  be increased to the next higher amount which is a multiple of
                  ten)
                </Text>
              </View>
              <View style={{ width: "20%" }}>
      ...
      <Page size="A4" orientation="portrait" style={styles.page}>
        <View style={styles.pageMainView}>
          ...
          >
            <Text style={[styles.title, { textAlign: "center", fontSize: 12 }]}>
          ...
          >
            ...
            >
              ...
              <View style={{ padding: 2 }}>
                <Text style={[styles.textBold, { marginLeft: 20 }]}>{pan}</Text>
              </View>
            </View>
          </View>
          <View
          ...
          >
            ...
            >
              <Text style={[styles.text, { textAlign: "left" }]}>l) GSLI</Text>
            </View>
          ...
          >
            ...
            >
              <Text style={[styles.textBold, { textAlign: "center" }]}>
                Total Amount deductible under any other provision (s) of Chapter
                VI-A
              </Text>
            </View>
          ...
          <View style={styles.mainBorderView}>
            ...
            <View style={styles.rowStartBorderView}>
              ...
              <View style={[styles.view10H0, { borderRightWidth: 0 }]}>
                <Text style={styles.text}>{marchBasic !== 0 ? "NIL" : ""}</Text>
              </View>
            </View>
            <View style={styles.rowStartBorderView}>
              <View style={[styles.rowFlexView, { width: "16%" }]}>
              ...
              <View style={[styles.view10H0, { borderRightWidth: 0 }]}>
                <Text style={styles.text}>{aprilBasic !== 0 ? "NIL" : ""}</Text>
              </View>
            </View>
            <View style={styles.rowStartBorderView}>
              <View style={[styles.rowFlexView, { width: "16%" }]}>
              ...
              <View style={styles.view16H0}>
                <Text style={styles.text}>{mayBasic !== 0 ? mayHRA : ""}</Text>
              </View>
              <View style={styles.view16H0}>
                <Text style={styles.text}>
                  {" "}
            ...
            <View style={styles.rowStartBorderView}>
              ...
              <View style={styles.view16H0}>
                <Text style={styles.text}>{juneBasic !== 0 ? juneDA : ""}</Text>
              </View>
              <View style={styles.view16H0}>
                <Text style={styles.text}>
                  {juneBasic !== 0 ? juneHRA : ""}
              ...
              <View style={[styles.view10H0, { borderRightWidth: 0 }]}>
                <Text style={styles.text}>{juneBasic !== 0 ? "NIL" : ""}</Text>
              </View>
            </View>
            <View style={styles.rowStartBorderView}>
              <View style={[styles.rowFlexView, { width: "16%" }]}>
              ...
              <View style={styles.view16H0}>
                <Text style={styles.text}>{julyBasic !== 0 ? julyDA : ""}</Text>
              </View>
              <View style={styles.view16H0}>
                <Text style={styles.text}>
                  {julyBasic !== 0 ? julyHRA : ""}
              ...
              <View style={[styles.view10H0, { borderRightWidth: 0 }]}>
                <Text style={styles.text}>{julyBasic !== 0 ? "NIL" : ""}</Text>
              </View>
            </View>
            <View style={styles.rowStartBorderView}>
              <View style={[styles.rowFlexView, { width: "16%" }]}>
            ...
            <View style={[styles.rowStartBorderView, { borderBottomWidth: 0 }]}>
              <View style={styles.view16H0}>
