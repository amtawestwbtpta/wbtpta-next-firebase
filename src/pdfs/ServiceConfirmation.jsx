          ...
          >
            <View style={styles.pageMainView}>
              ...
              <Text style={styles.text}>
                ...
                Inspector of Schools and in exercise of the power conferred upon
                the undersigned under the West Bengal Primary School Teachers’
                Recruitment Rules 2001 & as amended time to time, do hereby
                declare that the service of the undernoted teacher is confirmed
                from the date following the date of completion of two years of
              ...
              <View style={{ marginTop: 80 }}>
                <View style={styles.rowFlexView}>
                  ...
                  >
                    ...
                    <Text style={styles.text2}>Sub- Inspector of Schools</Text>
                  </View>
                </View>
              </View>
