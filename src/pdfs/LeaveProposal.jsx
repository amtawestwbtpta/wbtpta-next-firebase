              ...
              <View style={styles.tableStartBorderView}>
                ...
                {/* {teachersPrevLeaves.length > 0 &&
                  teachersPrevLeaves.map((leave, index) => {
                    ...
                    const prevServiceAge =
                      parseInt(endDate?.split("-")[2]) -
                      parseInt(doj?.split("-")[2]);
                    return (
                      // endingDate !== endDate &&
                      <View
                        style={[styles.rowStartView, { padding: 0 }]}
                        key={index}
                      >
                        <View
                          style={{
                        ...
                        >
                          {leaveNature === "MATERNITY" ? (
                            ...
                            <Text style={styles.text}>
                              {prevServiceAge}{" "}
                              <Text style={styles.titleMain}>&#215;</Text> 30
                              {"\n= "} {prevServiceAge * 30}
                            </Text>
                          )}
                        </View>
                        ...
                        >
                          <Text style={styles.text2}>{endDate}</Text>
                        </View>
                        <View
                          style={{
                            borderRightWidth: 1,
                        ...
                        >
                          <Text style={styles.text}>
                            {leaveType === "MATERNITY" ? "N/A" : days * 2}
                          </Text>
                        </View>
                        <View
                          style={{
                ...
                <View style={[styles.rowStartView, { padding: 0 }]}>
                  ...
                  >
                    <Text style={[styles.text, { fontSize: 11 }]}>
                      {leaveNature === "MATERNITY"
                        ? "NIL"
                        : `(${serviceAge * 30} - ${serviceAge * 30-balanceLeave})\n= ${
                            balanceLeave
                          }`}
                    </Text>
                  </View>
