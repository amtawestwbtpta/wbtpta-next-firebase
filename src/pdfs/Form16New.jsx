            ...
            <View style={styles.mainBorderView}>
              ...
              >
                <View style={[styles.tableStartBorderView]}>
                  ...
                  >
                    <Text style={styles.textBold}>QUALIFYING{"\n"} AMOUNT</Text>
                  </View>
                  <View
                    style={{
                      width: "20%",
                  ...
                  >
                    <Text style={styles.textBold}>DEDUCTION{"\n"} AMOUNT</Text>
                  </View>
                </View>
                <View
                  style={[
                ...
                {grossGSLI > 0 && (
                  ...
                  >
                    ...
                    >
                      <Text style={styles.textBold}>G.S.L.I. Subscription</Text>
                    </View>
                    <View
                      style={{
                        width: "20%",
                ...
                {lic > 0 && (
                  ...
                  >
                    ...
                    >
                      <Text style={styles.textBold}>L.I.C. / PLI Premium</Text>
                    </View>
                    <View
                      style={{
                        width: "20%",
